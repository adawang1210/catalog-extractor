...
### 兩件只有使用者能定(調研 AI 無法代答;仍空)
1. **本機 RAM**:判準=q4_K_M 14–16GB、含 128K context 建議 **32GB↑**、16GB 可能 OOM。**待告知。**
2. **「不出門」定義**:租 GPU 裸機——合規角度(受控 VPC/root/用後銷毀)多視為「不出門」、物理
   角度(完全本地無網)則否。**依你/客戶 NDA 資料落地要求定。**
